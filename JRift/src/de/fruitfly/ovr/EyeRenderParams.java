...
public class EyeRenderParams
{
        ...
        )
    {
        ...
        Eyes[0].Desc.Eye = EyeType.fromInteger(eye1Descfloat);
        Eyes[0].Desc.TextureSize.w = eye1DescTextureSizew;
        Eyes[0].Desc.TextureSize.h = eye1DescTextureSizeh;
        Eyes[0].Desc.RenderViewport.Pos.x = eye1DescRenderViewportPosx;
        Eyes[0].Desc.RenderViewport.Pos.y = eye1DescRenderViewportPosy;
        Eyes[0].Desc.RenderViewport.Size.w = eye1DescRenderViewportSizew;
        Eyes[0].Desc.RenderViewport.Size.h = eye1DescRenderViewportSizeh;
        Eyes[0].Desc.Fov.UpTan = eye1DescFovUpTan;
        Eyes[0].Desc.Fov.DownTan = eye1DescFovDownTan;
        Eyes[0].Desc.Fov.LeftTan = eye1DescFovLeftTan;
        Eyes[0].Desc.Fov.RightTan = eye1DescFovRightTan;
        ...
        Eyes[1].Desc.Eye = EyeType.fromInteger(eye2Descfloat);
        Eyes[1].Desc.TextureSize.w = eye2DescTextureSizew;
        Eyes[1].Desc.TextureSize.h = eye2DescTextureSizeh;
        Eyes[1].Desc.RenderViewport.Pos.x = eye2DescRenderViewportPosx;
        Eyes[1].Desc.RenderViewport.Pos.y = eye2DescRenderViewportPosy;
        Eyes[1].Desc.RenderViewport.Size.w = eye2DescRenderViewportSizew;
        Eyes[1].Desc.RenderViewport.Size.h = eye2DescRenderViewportSizeh;
        Eyes[1].Desc.Fov.UpTan = eye2DescFovUpTan;
        Eyes[1].Desc.Fov.DownTan = eye2DescFovDownTan;
        Eyes[1].Desc.Fov.LeftTan = eye2DescFovLeftTan;
        Eyes[1].Desc.Fov.RightTan = eye2DescFovRightTan;
